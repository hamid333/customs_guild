...
from core.models import DashboardAccess
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # ---------------- نمونه کاربر محدود (staff غیر مدیر کل) با دسترسی جزئی ----------------
        editor, created = User.objects.get_or_create(
            username="news-editor",
            defaults={"is_staff": True, "is_superuser": False, "email": "editor@example.com"},
        )
        if created:
